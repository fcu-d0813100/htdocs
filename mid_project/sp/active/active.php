        ...
        <tbody>
          <?php for ($i = 1; $i <= $per_page; $i++): ?>
            <tr class="align-middle">
              <td><?=$i?></td>
              <td class="ratio ratio-4x3 activePic"><img class="object-fit-cover " src="images/NARS2.webp" alt=""></td>
              <td>新品發表會暨專屬試妝活動</td>
              <td>placeholder</td>
              <td>
              ...
              <td>text</td>
              <td>
                <a href="active-list.php" class="btn btn-outline-secondary btn-lg">
